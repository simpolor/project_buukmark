		...
		<div id="section">
			<div class="ask-nav">
				<div class="ask-nav-title">
					<span>(관리자) 문의사항 수정</span>
				</div>
			</div>
			
			<div class="ask-write">
				<form:form id="askModifyForm" action="${pageContext.request.contextPath}/admin/ask/modify" method="post" commandName="askVO">
					<form:hidden path="ask_seq" />
					<table>
						<caption>관리자 문의사항 수정</caption>
						<colgroup>
							<col width="100%" />
						</colgroup>
						<thead>
