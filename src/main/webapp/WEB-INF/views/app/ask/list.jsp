...
<tiles:insertDefinition name="user-layout">
    <tiles:putAttribute name="user-body">
		...
		<script type="text/javascript">
			...
			function f_write(){
				location.href = '${pageContext.request.contextPath}/ask/write';
			}
		...
		<div id="section">
								...
								<c:forEach var="askList" items="${askList}">
									<tr>
							 			...
							 			<td align="left">
						 					...
						 					<a href="${pageContext.request.contextPath}/ask/view?ask_seq=${askList.ask_seq}">${askList.ask_title}</a>
							 			</td>
			...
			<div class="ask-pagination">
				<a href="${pageContext.request.contextPath}/ask/list?page=${paging.startPage}"><i class="fa fa-angle-double-left"></i></a>
				<a href="${pageContext.request.contextPath}/ask/list?page=${paging.prevPage}"><i class="fa fa-angle-left"></i></a>
				...
				<c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}">
					<c:choose>
						...
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/ask/list?page=${i}">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>

				<a href="${pageContext.request.contextPath}/ask/list?page=${paging.nextPage}"><i class="fa fa-angle-right"></i></a>
				<a href="${pageContext.request.contextPath}/ask/list?page=${paging.endPage}"><i class="fa fa-angle-double-right"></i></a>
			</div><!-- ask-pagination -->
				...
				<div class="ask-btn">
					<div class="ask-btn-list">
						<div class="ask-btn-group">
							<a href="${pageContext.request.contextPath}/ask/write">문의하기</a>
						</div>
					</div>
				</div><!-- ask-btn -->
			</c:if>
			...
			<div class="ask-search">
				<form:form id="askSearchForm" action="${pageContext.request.contextPath}/ask/list" method="get" commandName="askVO" style="margin: 0;" >
					<fieldset>
