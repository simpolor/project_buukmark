...
<tiles:insertDefinition name="admin-layout">
    <tiles:putAttribute name="admin-body">
		...
		<script type="text/javascript">
			...
			function f_modify(){
				$("#askViewForm").attr("action", "${pageContext.request.contextPath}/admin/ask/modify");
				$("#askViewForm").attr("method", "get");
				$("#askViewForm").submit();
			}
			
			function f_delete(){
				$("#askViewForm").attr("action", "${pageContext.request.contextPath}/admin/ask/delete");
			...
			<div class="ask-btn">
				<div class="ask-btn-list">
					<div class="ask-btn-group">
						...
						<a href="${pageContext.request.contextPath}/admin/ask/list">목록</a>
					</div>
				</div>
			</div>
