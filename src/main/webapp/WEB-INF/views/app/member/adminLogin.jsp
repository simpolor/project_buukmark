...
<tiles:insertDefinition name="admin-layout">
    <tiles:putAttribute name="admin-body">
		...
		<form:form id="hiddenLoginForm" commandName="memberVO" action="${pageContext.request.contextPath}/admin/member/login" method="post" style="display:none">
			<fieldset class="login-fieldset">
				<ul>
					<li><form:input path="member_id" placeholder="아이디" /></li>
					<li><form:password path="member_pw"  placeholder="비밀번호" /></li>
				</ul>
			</fieldset>
		</form:form>
