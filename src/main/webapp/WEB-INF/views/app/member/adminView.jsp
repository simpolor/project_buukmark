...
<tiles:insertDefinition name="admin-layout">
    <tiles:putAttribute name="admin-body">
		...
		<script type="text/javascript">
			...
			function f_edit(){
				 var url = '${pageContext.request.contextPath}/admin/member/edit';
	          $(location).attr('href', url);
			}
			
			function f_password() {
				var url = '${pageContext.request.contextPath}/admin/member/password';
				$(location).attr('href', url);
			}
			
			function f_home(){
				var url = "${pageContext.request.contextPath}/admin/bookmark/list";
	           $(location).attr('href', url);
			}
		</script>
