    ...
    <tiles:putAttribute name="user-body">
		...
		<div id="section">
							...
							<c:when test="${! empty noticeList}">
								<c:forEach var="noticeList" items="${noticeList}">
									<tr>
							 			...
							 			<td align="left"><a href="${pageContext.request.contextPath}/notice/view?notice_seq=${noticeList.notice_seq}">${noticeList.notice_title}</a></td>
			...
			<div class="notice-pagination">
				<a href="${pageContext.request.contextPath}/notice/list?page=${paging.startPage}"><i class="fa fa-angle-double-left"></i></a>
				<a href="${pageContext.request.contextPath}/notice/list?page=${paging.prevPage}"><i class="fa fa-angle-left"></i></a>
				...
				<c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}">
					<c:choose>
						...
						<c:otherwise>
							<a href="${pageContext.request.contextPath}/notice/list?page=${i}">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>

				<a href="${pageContext.request.contextPath}/notice/list?page=${paging.nextPage}"><i class="fa fa-angle-right"></i></a>
				<a href="${pageContext.request.contextPath}/notice/list?page=${paging.endPage}"><i class="fa fa-angle-double-right"></i></a>
			</div><!-- board-pagination -->
			
			<div class="notice-search">
				<form:form id="noticeSearchForm" action="${pageContext.request.contextPath}/notice/list" method="get" commandName="noticeVO" style="margin: 0;" >
					<fieldset>
