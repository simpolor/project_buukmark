CREATE TABLE `ask` (
	`ask_seq` INT(11) NOT NULL AUTO_INCREMENT COMMENT '문의사항 번호',
	`ask_title` VARCHAR(500) NOT NULL COMMENT '문의사항 제목',
	`ask_content` TEXT NOT NULL COMMENT '문의사항 내용',
	...
	`secret_yn` CHAR(1) NOT NULL DEFAULT 'N' COMMENT '비밀글 여부',
